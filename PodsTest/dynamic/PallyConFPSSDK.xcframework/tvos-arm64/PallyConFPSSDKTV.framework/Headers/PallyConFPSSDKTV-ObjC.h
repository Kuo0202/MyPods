...
///
- (void)prepareWithUrlAsset:(AVURLAsset * _Nonnull)urlAsset token:(NSString * _Nonnull)token licenseUrl:(NSString * _Nonnull)licenseUrl appleCertUrl:(NSString * _Nonnull)appleCertUrl;
...
///
- (void)prepareWithUrlAsset:(AVURLAsset * _Nonnull)urlAsset userId:(NSString * _Nonnull)userId contentId:(NSString * _Nonnull)contentId token:(NSString * _Nonnull)token licenseUrl:(NSString * _Nonnull)licenseUrl appleCertUrl:(NSString * _Nonnull)appleCertUrl liveKeyRotation:(BOOL)liveKeyRotation;
/// Sets data required for license acquisition of FPS content. This method must be called to start playback.
/// note:
/// It must be executed before playback.
/// \param urlAsset <code>AVURLAsset</code> of the content to be played.
